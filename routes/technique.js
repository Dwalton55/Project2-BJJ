...
router.put('/:techid', (req, res) => {
  ...
  User.findById(req.params.id)
    .then((user) => {
      const tech = user.gamePlans.id(gameid)[positionid].techniques.id(techid)
      console.log(user.gamePlans.id(gameid)[positionid].techniques)
      console.log(user.gamePlans.id(gameid)[positionid].techniques.id(techid))
...
router.delete('/:id', (req, res) => {
  User.findByIdAndRemove(req.params.posid)
    .then(() => {
